...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none",
  {
    variants: {
      variant: {
        default:
          "bg-white/40 dark:bg-white/[0.04] text-neutral-900 dark:text-neutral-100 hover:scale-[1.03] active:scale-[0.98] border border-white/60 dark:border-white/15",
        destructive:
      ...
      size: {
        ...
        xxl: "h-14 rounded-2xl px-10 text-base",
        icon: "h-9 w-9 p-0",
      },
    },
    defaultVariants: {
...
>(({ className, variant, size, children, ...props }, ref) => {
  return (
    <button
      ...
      {...props}
    >
      {/* Specular Liquid Rim & Inner Bevel Highlight */}
      <div
        className="pointer-events-none absolute inset-0 z-0 rounded-[inherit] 
          shadow-[0_0_6px_rgba(0,0,0,0.03),0_2px_6px_rgba(0,0,0,0.08),inset_3px_3px_0.5px_-3px_rgba(0,0,0,0.9),inset_-3px_-3px_0.5px_-3px_rgba(255,255,255,0.85),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.6),inset_-1px_-1px_1px_-0.5px_rgba(255,255,255,0.6),inset_0_0_6px_6px_rgba(0,0,0,0.12),inset_0_0_2px_2px_rgba(0,0,0,0.06),0_0_12px_rgba(255,255,255,0.15)] 
      ...
      {/* Refractive Liquid Glass Backdrop Blur */}
      <div
        className="pointer-events-none absolute inset-0 isolate -z-10 overflow-hidden rounded-[inherit]"
        style={{
          backdropFilter: 'url("#container-glass") blur(10px) saturate(180%)',
          WebkitBackdropFilter: 'url("#container-glass") blur(10px) saturate(180%)',
        }}
      />
...
function GlassFilter() {
  return (
    <svg
      className="pointer-events-none fixed h-0 w-0 opacity-0 -z-50"
      aria-hidden="true"
